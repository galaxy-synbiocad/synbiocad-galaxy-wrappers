# rpbasicdesign -- A command-line tool to convert rpSBML files into SBOL and CSV files ready-to-be used with DNA-Bot.

The open-source software package rpbasicdesign is available here : https://github.com/brsynth/rpbasicdesign

## How to run rpbasicdesign wrapper tests

In order to execute tests on rpbasicdesign wrapper, you need to:
  ...
  ```bash
  planemo test --conda_channels conda-forge,brsynth --conda_debug tools/BRSynthTools/rpbasicdesign/wrap.xml
  ```
